...
def _logout_state_name(bot_id: int) -> str:
    return get_logout_state(bot_id).value
...
DEFINITIONS: tuple[DefinitionEntry, ...] = (
    ...
    DefinitionEntry("Login", "Logout state.", _logout_state_name, "Shows the current logout stage without clicking."),
